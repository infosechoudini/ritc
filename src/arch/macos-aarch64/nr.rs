...
pub const MMAP: usize = 0x20000c5; //197;
...
pub const MAP_EXECUTABLE: usize =	0x1000;		/* mark it as an executable */
pub const MAP_LOCKED: usize =	0x2000;		/* pages are locked */
pub const MAP_NORESERVE: usize =	0x4000;		/* don't check for reservations */
pub const MAP_POPULATE: usize =	0x8000;		/* populate (prefault) pagetables */
pub const MAP_NONBLOCK: usize =	0x10000;		/* do not block on IO */
pub const MAP_STACK: usize =	0x20000;		/* give out an address that is best suited for process/thread stacks */
pub const MAP_HUGETLB: usize =	0x40000;		/* create a huge page mapping */
pub const MAP_SYNC: usize =	0x80000;		/* perform synchronous page faults for the mapping */
...
pub const MAP_SHARED_VALIDATE: usize = 0x03;	/* share + validate extension flags */
pub const MAP_TYPE: usize =	0x0f;		/* Mask for type of mapping */
pub const MAP_FIXED: usize =	0x10;		/* Interpret addr exactly */
pub const MAP_ANONYMOUS: usize =	0x1000;		/* don't use a file */


/* 0x0100 - 0x80000 flags are defined in asm-generic/mman.h */
pub const MAP_FIXED_NOREPLACE: usize =	0x100000;	/* MAP_FIXED which doesn't unmap underlying mapping */

/*
 * Flags for mlock
 */
pub const MLOCK_ONFAULT: usize =	0x01;		/* Lock pages in range after they are faulted in, do not prefault */

pub const MS_ASYNC: usize =	1;		/* sync memory asynchronously */
pub const MS_INVALIDATE: usize =	2;		/* invalidate the caches */
pub const MS_SYNC: usize =		4;		/* synchronous memory sync */
...
pub const MADV_HWPOISON: usize =	100	;	/* poison a page for testing */
pub const MADV_SOFT_OFFLINE: usize = 101;		/* soft offline page for testing */
...
pub const MADV_DODUMP: usize =	17;		/* Clear the MADV_DONTDUMP flag */
...
pub const PKEY_DISABLE_ACCESS: usize =	0x1;
pub const PKEY_DISABLE_WRITE: usize =	0x2;
pub const PKEY_ACCESS_MASK: usize =	(PKEY_DISABLE_ACCESS | PKEY_DISABLE_WRITE);
